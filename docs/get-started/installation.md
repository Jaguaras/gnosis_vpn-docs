...
[https://downloads.vpn.gnosis.eth.limo/](https://downloads.vpn.gnosis.eth.limo/)

Download the package that matches your operating system and follow the relevant installation guide in the Gnosis VPN wiki:

- **macOS:** [github.com/gnosis/gnosis_vpn/wiki/macOS](https://github.com/gnosis/gnosis_vpn/wiki/macOS)
